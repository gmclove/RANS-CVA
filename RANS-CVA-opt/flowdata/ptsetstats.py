...
ax.plot(ybins,meanC[20,:,i_inj1],'k-')
ax.plot(ybins,meanC[20,:,i_inj2],'k--')
ax.plot(ybins,meanC[30,:,i_inj1],'C0-')
ax.plot(ybins,meanC[30,:,i_inj2],'C0--')
ax.plot(ybins,meanC[40,:,i_inj1],'C1-')
ax.plot(ybins,meanC[40,:,i_inj2],'C1--')
ax.set_xlim(-6,6)
plt.show()